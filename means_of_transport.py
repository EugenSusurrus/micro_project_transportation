...
def means_transport():
    """
    The purpose this function is to find out kinds of transport being used in journey
    """
...
def main():
    """ Used to call the means_transport function which tabulate the kind of transport used"""    
means_transport()
